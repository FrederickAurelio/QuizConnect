...
function LandingPage() {
  ...
  return (
    <div className="h-[90%] w-full max-sm:h-full">
      <h1 className="sr-only">
        QuizConnect — host live multiplayer quizzes and play with friends
      </h1>
      <div className="scroll-primary grid h-full w-full grid-cols-2 overflow-x-hidden overflow-y-auto max-sm:grid-cols-1 max-sm:gap-10 max-sm:py-8 md:overflow-y-hidden">
        {/* JOIN */}
        <BackgroundWrapper className="group flex h-full flex-col items-center justify-center gap-6">
          ...
          <div className="flex flex-col items-center gap-0">
            <h2 className="text-4xl font-bold">Join Quiz</h2>
        ...
        <hr className="hidden border-white/10 max-sm:block" />
        {/* HOST */}
        <BackgroundWrapper className="group flex h-full flex-col items-center justify-center gap-6">
          ...
          <div className="flex flex-col items-center gap-1">
            <h2 className="text-4xl font-bold">Hosting?</h2>
